...
namespace LOTO_Aplikacija
{
    public partial class FrmLoto : Form
    {
        ...
        private void bttnUplati_Click(object sender, EventArgs e)
        {
            ...
            bool ispravnKombinacija = loto.UnesiUplaceneBrojeve(vrijednosti);
            if (ispravnKombinacija == true)
            {
                bttnOdigraj.Enabled = true;
            }
            else
            {
                bttnOdigraj.Enabled = false;
                MessageBox.Show("Kombinacija uplaćenih brojeva nije ispravna!");
            }
        }

        private void bttnOdigraj_Click(object sender, EventArgs e)
        {
